...
## Project Structure
    ...
    ├── testapiautosetting_125085  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125085`
...
2. Clone this repo and `cd testapiautosetting_125085`
